...
<head>
    ...
    <style>
        .body-bg {
            ...
            background-image: linear-gradient(315deg, #0067FF 0%, #008FFD 74%);
        }
    </style>
</head>
<body class="body-bg min-h-screen pt-12 md:pt-20 pb-6 px-2 md:px-0" style="font-family:'Nunito',sans-serif;">
    ...
    <main class="bg-white max-w-lg mx-auto p-8 md:p-12 my-10 rounded-xl shadow-2xl">
        <section>
            <h3 class="font-bold text-2xl">Welcome to Administrator</h3>
